...
//since it writing to the blockchaib we got to sign it with the private key
  const write = async()=>{
    const provider = new ethers.JsonRpcProvider("https://sepolia.infura.io/v3/ab449feacf2f498f9bea2740f9c55840");
    const contractAddress = "0xF18F373299E09d8bb4aB4D50efA2ac1c4164426f"
    const ERC_20ABI = [
	{
		"inputs": [
			{
...
// https://bafybeig3fwrp6tipbqpajhgxrjxemtjj6qmbal6rodrpqrxzzdf7xvbvmq.ipfs.nftstorage.link/
// https://bafybeie2qcku2p22bffun6hwfurkh55r7irqvucz455l732mjix3jiml6a.ipfs.nftstorage.link/
const privateKey = "5ccb69e0e14929628bdbdd4fbb1159f730f55c26eea04f8f370e6664546a5786"
const wallet = new ethers.Wallet(privateKey,provider)
const contract = new ethers.Contract(contractAddress,ERC_20ABI,wallet)


 ;const nextTokenIdBN = await contract.balanceOf(connectedAddress).then(value => value);
